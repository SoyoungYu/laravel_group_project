...
<head>
    ...
    #navibar a {
        ...
        body.modern [data-theme*=_bgp] a,
        body.modern [data-theme*=_bgp] a:hover {
            color: white;
        }
        ...
        body.modern [data-theme*=_bgs] a,
        body.modern [data-theme*=_bgs] a:hover {
            color: white;
        }
        ...
        .MOD_MENU_Nav > ul li a:focus,
        .MOD_MENU_Nav > ul li a:hover,
        .MOD_MENU_Nav > ul li a:active {
            filter: brightness(1.1);
        }
        ...
        .MOD_MENU_Nav > ul ul a:focus,
        .MOD_MENU_Nav > ul ul a:hover,
        .MOD_MENU_Nav > ul ul a:active {
            filter: brightness(1.2);
        }
        ...
        .MOD_HEADER2_SocialBar .smIcon,
        .MOD_HEADER2_SocialBar svg {
            width: 2rem;
            height: 2rem;
        }
        ...
        .MOD_BLOGROLL1_Pagination ul li:first-child,
        .MOD_BLOGROLL1_Pagination ul li:last-child {
            flex: 0 0 100%;
        }
        ...
        .MOD_ARTICLEBLOCKS1_BlockLarge,
        .MOD_ARTICLEBLOCKS1_BlockSmall {
            background: white;
            margin: 1rem;
            display: flex;
        ...
        .MOD_ARTICLEBLOCKS2_BlockLarge,
        .MOD_ARTICLEBLOCKS2_BlockSmall {
            background: white;
            margin: 1rem;
            display: flex;
            flex-direction: column;
